...
//=====================================================================================================
		...
		//--------------------------------------------------------
         ...
         function drawBasic() {
             ...
             if(${menuSalesList[0].sales_count2 >0}){
               var data = google.visualization.arrayToDataTable([
                 ['총매출', '매출이익(원)', { role: 'annotation' },
                          '매출원가(원)', { role: 'annotation' } ],
                 
                 ['총매출', ${menuSalesSum.sum_sales_income},  ${menuSalesSum.sum_sales_income},
                          ${menuSalesSum.sum_sales_amount - menuSalesSum.sum_sales_income}, ${menuSalesSum.sum_sales_amount - menuSalesSum.sum_sales_income}]
               ]);
       ...
       <div class="col-lg-11" align="center">
            <section class="panel">
              <header class="panel-heading" style="background-color:#7f9ed436;">
                	   <font color="#39485f">메뉴별 매출관리</font>
              </header>
            ...
            <table class="table table-striped table-advance table-hover" id="select">
         	...
         	<tr>
                <td align=center  class="sumSales" style="padding:0 0 30 0">
                     ...
                     [매출이익] : ${menuSalesSum.sum_sales_income}원
                  ...
                  <tr>
	               ...
	               <%-- 게시판 목록 중에 각 행의 정순 일련번호 출력--%>
	     			 ${menuSalesSearchDTO.selectPageNo*menuSalesSearchDTO.menuRowCntPerPage-menuSalesSearchDTO.menuRowCntPerPage+1
	                                                               +loopTagStatus.index}  
	               <!-- 각 행의 상호명 출력 -->
	               	<td align=center width="10%" >${menuSales.business_name2}
	               <!-- 각 행의 메뉴 이름 출력 -->
	               	<td align=center width="10%" >${menuSales.menu_name2}
	               <!-- 각 행의 메뉴 가격 출력 -->
	               	<td  align=right width="8%"  class="menu_price">${menuSales.menu_price2}
	               <!-- 각 행의 판매 수량 출력 -->
	               	<td align=center width="7%" class="menu_sales_count">${menuSales.sales_count2}
	               <!-- 각 행의 총매출 출력 -->
	               	<td   align=right width="8%" class="menu_sales_amount">${menuSales.sales_amount2}
	               <!-- 각 행의 순매출 출력 -->
	               	<td   align=right width="8%" class="menu_sales_income">${menuSales.sales_income2}
